...
int main(int argc, char *argv[]) {
    ...
    proxyModel->setRecursiveFilteringEnabled(false); // Falls an, sofort ausmachen!
    proxyModel->setDynamicSortFilter(false); // Verhindert ständiges Neu-Sortieren während des Tippens
